...
<html lang="en">
  <head>
    ...
    $url="http://172.19.0.5/api/get_staff_courses_all/$fpid";
  ...
  ?>
                              ...
                              <tbody>
                                ...
                                <td><?= $row->course_name;?></td>
                                  <td><center><a class="btn btn-warning btn-xs btn-round" id="lecture_submit" href="my_course_page.php?ac_year=<?php echo $ac_year;?>&semester=<?php echo $semester;?>&course_code=<?php echo $row->course_code;?>&course_name=<?php echo $row->course_name;?>&course_id=<?php echo $row->course_id;?>" name="lecture_submit"> <strong>View</strong> </a></td>
                                      </tr>
                                <?php
                  $count++;    }  } 
                      ?>
